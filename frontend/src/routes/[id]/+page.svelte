...
<div class="max-w-3xl mx-auto pb-24 md:pb-8">
  ...
  <!-- Метаданные — горизонтальный скролл на мобильных -->
  <div class="flex gap-3 overflow-x-auto pb-1 mb-4 snap-x scrollbar-hide">
    <div class="card flex-shrink-0 snap-start !p-3 !rounded-2xl min-w-[120px]">
      <p class="text-[10px] text-gray-400 uppercase tracking-wide mb-1">Возраст</p>
      <p class="text-sm text-gray-800 font-medium leading-tight">{getAgeGroupNames(card.age_groups)}</p>
    </div>
    <div class="card flex-shrink-0 snap-start !p-3 !rounded-2xl min-w-[130px]">
      <p class="text-[10px] text-gray-400 uppercase tracking-wide mb-1">Навыки</p>
      <p class="text-sm text-gray-800 font-medium leading-tight">{getSkillNames(card.skills)}</p>
    </div>
    <div class="card flex-shrink-0 snap-start !p-3 !rounded-2xl min-w-[130px]">
      <p class="text-[10px] text-gray-400 uppercase tracking-wide mb-1">Этап урока</p>
      <p class="text-sm text-gray-800 font-medium leading-tight">{getStageNames(card.stages)}</p>
    </div>
    <div class="card flex-shrink-0 snap-start !p-3 !rounded-2xl min-w-[120px]">
      <p class="text-[10px] text-gray-400 uppercase tracking-wide mb-1">Тип работы</p>
      <p class="text-sm text-gray-800 font-medium leading-tight">{getTypeNames(card.types)}</p>
    </div>
  </div>
